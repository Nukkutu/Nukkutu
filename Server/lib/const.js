...
*/
	...
	'KKT': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "k32", "rcc", "any" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KSH': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "rcc", "any" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
